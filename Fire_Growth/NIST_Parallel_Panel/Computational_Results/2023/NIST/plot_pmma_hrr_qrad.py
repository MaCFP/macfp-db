...
lns3=ax1.plot(Time_FDS_1,HRR_FDS_1,marker='None',linestyle='--',color='steelblue',label='FDS 1 cm')
lns4=ax1.plot(Time_FDS_2,HRR_FDS_2,marker='None',linestyle='-.',color='steelblue',label='FDS 2 cm')
