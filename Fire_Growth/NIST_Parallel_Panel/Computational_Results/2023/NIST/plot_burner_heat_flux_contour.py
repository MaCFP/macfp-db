...
Z5 = np.zeros((4,5))
Z5[0,:] = M5.loc[60,"HF_y-25z20":"HF_y25z20"].values[:].astype(float)
Z5[1,:] = M5.loc[60,"HF_y-25z50":"HF_y25z50"].values[:].astype(float)
Z5[2,:] = M5.loc[60,"HF_y-25z75":"HF_y25z75"].values[:].astype(float)
Z5[3,:] = M5.loc[60,"HF_y-25z100":"HF_y25z100"].values[:].astype(float)
