...
Dataplot_Inputs_File = 'NIST_Parallel_Panel_inputs.csv'
...
saved_data, drange = fdsplotlib.dataplot(config_filename=Dataplot_Inputs_File,
                                         ...
                                         close_figs=True,
                                         verbose=True,
                                         plot_range=["NIST/NRC Parallel Panels"],
                                         ) # see notes below on plot_range

# Special cases

print("NIST_NRC_Parallel_Panels...");     safe_run("./NIST_NRC_Parallel_Panels.py")
