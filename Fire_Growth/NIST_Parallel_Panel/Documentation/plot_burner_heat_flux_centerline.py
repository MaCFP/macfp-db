...
f = macfp.plot_to_fig(x_data=x, y_data=y, data_label='Beaulieu, 2007',marker_style='+',marker_size=10,line_style='None')
...
f = macfp.plot_to_fig(x_data=x, y_data=y, data_label='Wu, 1997',marker_style='d',marker_size=10,line_style='None',figure_handle=f)
