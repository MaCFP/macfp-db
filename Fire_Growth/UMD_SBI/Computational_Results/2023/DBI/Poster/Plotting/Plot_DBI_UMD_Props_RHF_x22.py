...
x_string_exp1 = exp_data1['RADIATIVE_HEAT_FLUX_x22_145-z']  # Replace 'X_Column' with the appropriate column name
y_string_exp1 = exp_data1['RADIATIVE_HEAT_FLUX_x22_105']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['RADIATIVE_HEAT_FLUX_x22_145']

# Read the simulation data 185 s

y_string_exp3 = exp_data1['RADIATIVE_HEAT_FLUX_x22_185']
...
plt.title('Radiative Heat Flux x22',fontsize=14)  
plt.xlabel('Distance above burner(m)',fontsize=16)
plt.ylabel('Radiative Heat Flux (kW/m$^2$)',fontsize=16)  
plt.axis([0, 1.6, 0, 60])
...
save_filename = 'Radiative_Heat_Flux_x22.pdf'
