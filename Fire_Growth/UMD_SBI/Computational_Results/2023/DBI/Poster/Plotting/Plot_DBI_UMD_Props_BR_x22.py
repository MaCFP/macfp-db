...
x_string_exp1 = exp_data1['BURNING_RATE_x22_105-z']  # Replace 'X_Column' with the appropriate column name
y_string_exp1 = exp_data1['BURNING_RATE_x22_105']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['BURNING_RATE_x22_145']

# Read the simulation data 185 s

y_string_exp3 = exp_data1['BURNING_RATE_x22_185']
...
# save_filename = 'Burning_rate_x22.pdf'
# save_path = os.path.join(save_folder, save_filename)

plt.savefig('Burning_rate_x22.pdf', dpi=1600)
