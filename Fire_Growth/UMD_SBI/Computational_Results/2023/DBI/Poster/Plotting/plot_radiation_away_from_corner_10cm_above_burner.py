...
column_to_plot = 'RHF_z10'  # Replace with the actual column name
...
y_string_exp1_error = exp_data1.iloc[2:, 7]  # HRR error
...
plt.title('Radiative Heat Flux at 10 cm above burner',fontsize=14)  
...
save_filename = 'Radiative Heat Flux away from corner 10 cm above burner.pdf'
