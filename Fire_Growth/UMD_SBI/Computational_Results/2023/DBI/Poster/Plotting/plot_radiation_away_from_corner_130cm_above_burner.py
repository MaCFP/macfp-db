...
column_to_plot = 'RHF_z130'  # Replace with the actual column name
...
plt.title('Radiative Heat Flux at 130 cm above burner',fontsize=14)  
...
save_filename = 'Radiative Heat Flux away from corner 130 cm above burner.pdf'
