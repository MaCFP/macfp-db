...
x_string_exp1 = exp_data1['WALL_TEMPERATURE_x22_105-z']  # Replace 'X_Column' with the appropriate column name
y_string_exp1 = exp_data1['WALL_TEMPERATURE_x22_105']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['WALL_TEMPERATURE_x22_145']

# Read the simulation data 185 s

y_string_exp3 = exp_data1['WALL_TEMPERATURE_x22_185']
...
plt.title('Wall Temperature x22',fontsize=14)  
plt.xlabel('Distance above burner(m)',fontsize=16)
plt.ylabel('Wall Temperature ($^\circ$C)',fontsize=16)  
plt.axis([0, 1.6, 0, 600])
...
save_filename = 'Wall_Temperature_x22.pdf'
