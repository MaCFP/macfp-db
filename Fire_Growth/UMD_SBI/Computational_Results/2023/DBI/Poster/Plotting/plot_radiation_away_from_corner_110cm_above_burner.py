...
column_to_plot = 'RHF_z110'  # Replace with the actual column name
...
plt.title('Radiative Heat Flux at 110 cm above burner',fontsize=14)  
...
save_filename = 'Radiative Heat Flux away from corner 110 cm above burner.pdf'
