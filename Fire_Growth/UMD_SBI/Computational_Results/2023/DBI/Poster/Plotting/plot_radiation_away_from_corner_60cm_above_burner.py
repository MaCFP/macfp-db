...
column_to_plot = 'RHF_z50'  # Replace with the actual column name
...
plt.title('Radiative Heat Flux at 60 cm above burner',fontsize=14)  
...
save_filename = 'Radiative Heat Flux away from corner 60 cm above burner.pdf'
