...
path1 = r'E:\macfp-db-master\macfp-db-master\Fire_Growth\UMD_SBI\Computational_Results\2023\DBI\plotting\Experimental_Data\Total_HF_binned_y_10cm.csv'
...
y_string_exp1 = exp_data1['HFG_x10_y10']
...
y_string_exp2 = exp_data2['HFG_x10_y10']
...
plt.title('Gaugage Heat Flux at x10 y10',fontsize=14)  
...
save_filename = 'Gaugage_Heat_Flux_x10_y10.pdf'
