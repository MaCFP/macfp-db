...
x_string_exp1 = exp_data1['BURNING_RATE_x5_105-z']  # Replace 'X_Column' with the appropriate column name
y_string_exp1 = exp_data1['BURNING_RATE_x5_105']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['BURNING_RATE_x5_145']

# Read the simulation data 185 s

y_string_exp3 = exp_data1['BURNING_RATE_x5_185']
...
plt.title('Burning rate x5',fontsize=14)  
plt.xlabel('Distance above burner(m)',fontsize=16)
plt.ylabel('Burning Rate (kg/s)',fontsize=16)  
plt.axis([0, 1.6, 0, 0.03])
...
# save_folder = r'../../../../Computational_Results/2023/DBI/plotting'

# save_filename = 'Burning_rate_x5.pdf'
# save_path = os.path.join(save_folder, save_filename)

plt.savefig('Burning_rate_x5.pdf', dpi=1600)
