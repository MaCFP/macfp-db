...
x_string_exp1 = exp_data1['NET_HEAT_FLUX_x5_145-z']  # Replace 'X_Column' with the appropriate column name
y_string_exp1 = exp_data1['NET_HEAT_FLUX_x5_105']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['NET_HEAT_FLUX_x5_145']

# Read the simulation data 185 s

y_string_exp3 = exp_data1['NET_HEAT_FLUX_x5_185']
...
plt.title('Net Heat Flux x5',fontsize=14)  
...
save_filename = 'Net_Heat_Flux_x5.pdf'
