...
y_string_exp1 = exp_data1['TEMPERATURE_RMS_x22_30']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['TEMPERATURE_RMS_x22_90']
...
plt.title('RMS Temperature x=22 t=105s',fontsize=14)  
...
save_filename = 'RMS_Temprerature_x22_t105s.pdf'
