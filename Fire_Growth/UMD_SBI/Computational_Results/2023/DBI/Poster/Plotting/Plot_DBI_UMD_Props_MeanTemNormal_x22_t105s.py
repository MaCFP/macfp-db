...
y_string_exp1 = exp_data1['TEMPERATURE_x22_30']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['TEMPERATURE_x22_90']
...
plt.plot(x_exp1, y_exp1, c='black', alpha=0.9, label='x22y30')
plt.plot(x_exp1, y_exp2, c='blue', alpha=0.9, label='x22y90')


plt.title('Mean Temperature x=22 t=105s',fontsize=14)  
plt.xlabel('Distance from the Panel (m)',fontsize=16)
plt.ylabel('Mean Temperature ($^\circ$C)',fontsize=16)  
plt.axis([0, 0.7, 0, 400])
...
save_filename = 'Mean_Temprerature_x22_t105s.pdf'
