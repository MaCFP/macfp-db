...
y_string_exp1 = exp_data1['TEMPERATURE_x5_30']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['TEMPERATURE_x5_90']
...
save_filename = 'Mean_Temprerature_x5_t105s.pdf'
