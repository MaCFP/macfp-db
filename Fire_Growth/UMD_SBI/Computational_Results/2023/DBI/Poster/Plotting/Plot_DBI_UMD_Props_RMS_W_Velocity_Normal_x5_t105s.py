...
y_string_exp1 = exp_data1['W-VELOCITY_RMS_x5_30']

# Read the simulation data 145 s

y_string_exp2 = exp_data1['W-VELOCITY_RMS_x5_90']
...
plt.title('RMS W-Velocity x=5 t=105s',fontsize=14)  
...
save_filename = 'RMS_W_Velocity_Normal_x5_t105s.pdf'
