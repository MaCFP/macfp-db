...
column_to_plot = 'RHF_z70'  # Replace with the actual column name
...
plt.title('Radiative Heat Flux at 85 cm above burner',fontsize=14)  
...
save_filename = 'Radiative Heat Flux away from corner 85 cm above burner.pdf'
