...
M1 = pd.read_csv('Development/NIST_Methanol_1m_pan_4cm_grid_predicted_puffing_devc.csv', header=1, sep=' *, *', engine='python')
M2 = pd.read_csv('Development/NIST_Methanol_1m_pan_2cm_grid_predicted_puffing_devc.csv', header=1, sep=' *, *', engine='python')
M3 = pd.read_csv('Development/NIST_Methanol_1m_pan_1cm_grid_predicted_puffing_devc.csv', header=1, sep=' *, *', engine='python')

fs1 = len(M1['Time'])/max(M1['Time'])
fs2 = len(M2['Time'])/max(M2['Time'])
fs3 = len(M3['Time'])/max(M3['Time'])

x1 = M1['WVEL'][M1['Time']>20.]
x2 = M2['WVEL'][M2['Time']>20.]
x3 = M3['WVEL'][M3['Time']>20.]
...
fh=macfp.plot_to_fig(fmeas, PSDmeas,
                  ...
                  line_width=2,
                  line_color='black',
                  institute_label='NIST Development',
                  data_label='Exp',
...
fh=macfp.plot_to_fig(f1, Pxx_den_1, plot_type='linear',x_min=0.5,x_max=4,y_min=0,y_max=15,x_label='frequency [Hz]',y_label='PSD [V**2/Hz]',data_label='FDS $\Delta x=4$ cm', line_style='-', line_width=1,line_color='black',  marker_style='o',marker_size=4,marker_edge_color='black', marker_fill_color='None',figure_handle=fh,show_legend=True,legend_location='right')
fh=macfp.plot_to_fig(f2, Pxx_den_2, plot_type='linear',x_min=0.5,x_max=4,y_min=0,y_max=15,x_label='frequency [Hz]',y_label='PSD [V**2/Hz]',data_label='FDS $\Delta x=2$ cm', line_style='-', line_width=1,line_color='magenta',marker_style='^',marker_size=4,marker_edge_color='magenta',marker_fill_color='None',figure_handle=fh,show_legend=True,legend_location='right')
fh=macfp.plot_to_fig(f3, Pxx_den_3, plot_type='linear',x_min=0.5,x_max=4,y_min=0,y_max=15,x_label='frequency [Hz]',y_label='PSD [V**2/Hz]',data_label='FDS $\Delta x=1$ cm', line_style='-.',line_width=1,line_color='red',marker_style='s',marker_size=4,marker_edge_color='red', marker_fill_color='None',figure_handle=fh,show_legend=True,legend_location='right')

# plt.show()

plt.savefig('./Development/Plots/NIST_1m_Methanol_puffing_frequency.pdf')

# loglog spectrum
fh2=macfp.plot_to_fig(f3, Pxx_den_3, plot_type='loglog',x_min=0.5,x_max=1000,y_min=.00001,y_max=100,x_label='frequency [Hz]',y_label='PSD [V**2/Hz]',plot_title='NIST 1 m Methanol Power Spectrum',data_label='FDS $\Delta x=1$ cm',line_style='-', line_width=1,line_color='black',show_legend=True,legend_location='lower left',legend_framealpha=1.,institute_label='NIST Development')
...
plt.savefig('./Development/Plots/NIST_1m_Methanol_Power_Spectrum.pdf')
