...
x[kW]& File Format: 1 column of data (total HRR)\\
...
x[kW m$^{-2}$]& File Format: 7 columns of data (total heat flux, at 7 different heights above top of burner)\\ 
	& Resolution: Time-resolved predictions at 5 Hz \\
	& Duration: Minimum of 200 s or 300 kW (whichever is greater) \\
...
x[kW m$^{-2}$]& File Format: each file contains 4 columns of data (total flame heat flux, at a given height, at 4 locations away from the corner wall)\\
	& Resolution: Time-resolved predictions at 5 Hz \\
	& Duration: Minimum of 200 s or 300 kW (whichever is greater) \\
