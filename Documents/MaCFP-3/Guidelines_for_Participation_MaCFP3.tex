...
The \href{https://github.com/MaCFP/macfp-db/tree/master/Extinction/NIST_Pool_Fires}{FM-Burner} corresponds to a 13.7 cm diameter, controlled coflow (a mixture of air and nitrogen), round ethylene diffusion flame experiment currently studied at FM Global (see documentation here). Case 2 includes global measurements at coflow oxygen mole fractions of 20.9%, 19%, 17% and 15%, and detailed measurements at coflow oxygen mole fraction of 20.9%, 16.8% and 15.2%. Groups interested in simulating Case 2 are invited to predict the changes in flame radiation. Simulations with a prescribed radiant fraction (taken as the measured averaged value) are acceptable as well.
