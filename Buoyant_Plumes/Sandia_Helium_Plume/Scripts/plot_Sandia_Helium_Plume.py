...
for irow in C.index:
    ...
    if pp.Plot_Filename!=Plot_Filename_Last:
        ...
        x = E[pp.Exp_x_Col_Name][::pp.Exp_Data_Skip+1]
        y = E[pp.Exp_y_Col_Name][::pp.Exp_Data_Skip+1]
    ...
    x = M[pp.Cmp_x_Col_Name][::pp.Cmp_Data_Skip+1]
    y = M[pp.Cmp_y_Col_Name][::pp.Cmp_Data_Skip+1]
    ...
    plt.savefig(pltdir + pp.Plot_Filename + '.' + pp.Plot_Filetype)
